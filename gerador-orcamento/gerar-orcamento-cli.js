...
async function promptForProposal() {
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      default: 'HB Medicinal / HB Treinamentos',
    },
    {
      type: 'input',
      name: 'serviceTitle',
      message: 'Título do serviço:',
      default: 'Reestruturacao de acessos Microsoft / OneDrive e organizacao de arquivos corporativos',
    },
    {
      type: 'input',
      name: 'serviceDescription',
      message: 'Descrição breve do serviço:',
      default: 'Proposta comercial para reorganizacao de contas corporativas, backup preventivo de arquivos e reconfiguracao de ambiente OneDrive nas estacoes atendidas.',
    },
    {
      type: 'input',
      name: 'value',
  ...
  let includes = [
    ...
    'Bonus de cortesia: limpeza profunda preventiva incluindo troca de pasta termica e troca de bateria da BIOS, sem custo adicional.',
  ];
