...
const companyInfo = {
  company: 'Leo Celulares',
  whatsapp: '+55 62 98609-8281',
  email: 'contato@leocelulares.com.br',
};
...
async function promptForProposal() {
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      default: 'Assistência técnica em smartphones e troca de componentes',
    },
    {
      type: 'input',
      name: 'serviceDescription',
      message: 'Descrição breve do serviço:',
      default: 'Proposta comercial para manutenção de smartphones, troca de tela, bateria e conectores com testes completos.',
    },
    {
      type: 'input',
      name: 'value',
  ...
  let scope = [
    'Avaliação técnica do aparelho e diagnóstico do defeito.',
    'Desmontagem segura com instrumentos apropriados.',
    'Substituição de peça aprovada (tela, bateria, conector ou similar).',
    'Limpeza técnica e revisão dos contatos internos.',
    'Testes funcionais de carga, toque, áudio e sensores.',
    'Validação final do reparo e garantia de funcionamento.',
  ...
  let includes = [
    ...
    'Mão de obra e testes completos.',
    'Validação final antes da entrega.',
    'Orientação de uso e cuidados pós-serviço.',
    'Cortesia: limpeza técnica preventiva e película simples, quando aplicável, sem custo adicional.',
  ];
